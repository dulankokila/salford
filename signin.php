        ...
        <div id="signInForm">
          ...
          <div class="d-flex justify-content-between">
            ...
            <div class="d-flex align-items-center col justify-content-end m-0 p-0">
              <a href="#!" class="m-0 " onclick="frogotpassword();">
          ...
          <div class="row justify-content-center  mt-5"><img src="images/2993685_brand_brands_google_logo_logos_icon (1).png" class="icon mx-3" /><img src="images/4202105_microsoft_logo_social_social media_icon.png" class="icon mx-3" /><img src="images/5296499_fb_facebook_facebook logo_icon.png" class="icon mx-3" /></div>
