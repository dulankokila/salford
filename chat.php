        ...
        <div class="row">
            ...
            <div class="col-12 py-5 px-4">
                <div class="row overflow-hidden shadow rounded">
                                                ...
                                                ?>
                                                        <div class="list-group rounded-0" onclick="viewMessages('<?php echo $msg_data['from']; ?>');">
                                                            <a href="#" class="list-group-item list-group-item-action text-dark rounded-0">
                                                                ...
                                                                $img_rs = Database::search("SELECT * FROM `image` WHERE `user_email`='" . $msg_data["from"] . "'");
                                                    ...
                                                    <div class="list-group rounded-0" onclick="viewMessages('<?php echo $msg_data['from']; ?>');">
                                                        <a href="#" class="list-group-item list-group-item-action text-black rounded-0 ">
                                                            <div class="media">
                                                                ...
                                                                $img_rs2 = Database::search("SELECT * FROM `image` WHERE `user_email`='" . $msg_data2["to"] . "'");
                    ...
                    <div class="col-12 col-lg-12 px-2 mt-4">
                        <div class="row">
